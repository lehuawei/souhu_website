...
<head>
    ...
    <link rel="stylesheet" href="css/about_response.css">
...
<header>
    <div class="head bs">
        ...
        <div class="nav_span">
            ...
            <span class="nav_a"><a href="#" class="about orange " title="about.html">关于我们</a></span>
...
<article>
    <div class="banner"><img src="images/about_us/about_banner.jpg" alt="" id="jump"></div>

    <section>
        <div class="black_bar slider">
            <ul>
                <li class="orange"><span>公司简介</span></li><img class="img1" src="images/common/Split_line.jpg" alt="" height="50px" width="1px" style="display: none">
                <li><span>发展历程</span></li> <img src="images/common/Split_line.jpg" alt="" height="50px" width="1px" class="img2">
                <li><span>产品体系</span></li> <img src="images/common/Split_line.jpg" alt="" height="50px" width="1px" class="img3">
    ...
    <section>
        <div class="yd_ad">
            ...
            <div class="environment">
                <div class="lft">
                    <div style="width: 100%;"class="img_up"><img src="images/about_us/introduce/introdure_pic1.jpg" alt=""></div>
                    <div style="width: 100%;" class="img_down">
                        <img src="images/about_us/introduce/introdure_pic3.jpg" alt="">
                        <img src="images/about_us/introduce/introdure_pic4.jpg" alt="">
                    </div>
                </div>
                <div class="rit">
                    <img src="images/about_us/introduce/introdure_pic2.jpg" alt="">
                </div>
            </div>
        </div>
        <div class="yd_ad " style="display: none">
            ...
            <div class="bg_img">
                <img style="position: relative;" src="images/about_us/develop_history/develop_pic_2.png" alt="">
        ...
        <div class="yd_ad" style="display: none">
            ...
            <p>产品体系</p>
            <div style="width: 60px;height: 2px;background-color: #575757;margin-top: 24px;"></div>
            <div class="pro"><img src="images/about_us/product/product_pic.png" alt=""></div>
        </div>
        <div class="yd_ad" style="display: none">
            <h1>OUR TEAM</h1>
            <p>团队介绍</p>
            ...
            <ul class="img_person fade">
                <li class="one portrait" title="0">
                    <img src="images/about_us/team/team_pic.jpg" alt="">
                   <!-- <div class="name">
                        <p class="big">周孝龙</p>
                        <p class="small">CEO</p>
                    </div>-->
            ...
            <div class="contact">
                ...
                <div class="con_right">
                    <div>
                        ...
                        <p><img src="images/common/footer_icon2.png" alt=""><span>&nbsp;&nbsp;深圳市南山区南头检查站智恒产业园22栋3楼</span></p>
                    </div>
                </div>
            </div>
