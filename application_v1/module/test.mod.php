    ...
    <div class="recharge_bg">
        <div class="recharge_wh">
            ...
            <p class="tit_rc">
             ...
             <form method="post" id="form" action="<?php echo API_URL;?>?mod=api" target="_blank">
...
var curr_selectPId = 0;
 $(function(){
    ...
    $('.weiPay').click(function () {
        ...
        //     $(".opacity_color").css("display",'block');
        // }
        // var data = {action:"userOrder",shopId:1,payType:2,num:1000,userPId:1};
        // alert('<?php echo API_URL;?>?mod=api');
        // $.post('<?php echo API_URL;?>?mod=api',data,function(result){
