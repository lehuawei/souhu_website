 ...
 */
(function($) {
    //给fullpage指向一个函数 里面有对应的属性和方法
    $.fn.fullpage = function(options) {//jQuery.fn = jQuery.prototype.
        // Create some defaults, extending them with any options that were provided
        options = $.extend({//是jquery为开发插件提供的方法
            //navigation
            'menu': false,
            'anchors':[],
            'navigation': false,
        ...
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $('.fp-section').length; i++) {
                ...
                var leftda=$("#leftdata"+i).html();//undefined
